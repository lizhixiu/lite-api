<template>
  <el-container>
    <el-aside width="300px">
      <xcTree title="产品导航树" label="nameTxt" url="/lite/nav/liteNav/comTree"
    ...
    <el-container>
      ...
      <el-main class="nopadding">
        <xcTable title="产品导航列表" ref="tableRef" url="/lite/nav/liteNav/page" row-key="id" stripe @selection-change="handleTableSelectionChange">
          <el-table-column type="selection" width="50"></el-table-column>
          <el-table-column type="index" label="序号" width="50"></el-table-column>
          <el-table-column label="导航编码" prop="codeTxt" width="180" ></el-table-column>
          <el-table-column label="导航名称" prop="nameTxt" width="180" ></el-table-column>
          <el-table-column label="导航图标" prop="iconTxt" width="180" ></el-table-column>
          <el-table-column label="导航类型" prop="typeRef" width="180" ></el-table-column>
...
export default {
  ...
  methods: {
    handleAdd() {
      let context = {};
      context.title = '产品导航|新增';
      context.src = 'lite/nav/liteNav/liteNavForm';
      context.actionType = 'add';
      context.param = {pid: this.$refs.treeRef.getCurrentKey()};
      context.dataBind = "/lite/nav/liteNav/prepare";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleView(row) {
      let context = {};
      context.title = '产品导航|详情';
      context.src = 'lite/nav/liteNav/liteNavForm';
      context.actionType = 'view';
      context.param = {
        id: row.id
      };
      context.dataBind = "/lite/nav/liteNav/get";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleEdit(row) {
      let context = {};
      context.title = '产品导航|编辑';
      context.src = 'lite/nav/liteNav/liteNavForm';
    ...
    handleCopy(row) {
      let context = {};
      context.title = '产品导航|拷贝';
      context.src = 'lite/nav/liteNav/liteNavForm';
      context.actionType = 'copy';
      context.param = {
        rowId: row.id
      }
      context.dataBind = "/lite/nav/liteNav/copy";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleDelete(row) {
      ...
      context.deleteAction = '/lite/nav/liteNav/delete';
    ...
    handleBatchDelete() {
      ...
      context.deleteAction = '/lite/nav/liteNav/deletes';
