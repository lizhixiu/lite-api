  ...
  <el-container>
    ...
    <el-container>
      ...
      <el-main class="nopadding">
        <xcTable title="岗位表列表" ref="tableRef" url="/lite/post/litePost/page" row-key="id" stripe @selection-change="handleTableSelectionChange">
          <el-table-column type="selection" width="50"></el-table-column>
          <el-table-column type="index" label="序号" width="50"></el-table-column>
          <el-table-column label="岗位编码" prop="codeTxt" width="180" ></el-table-column>
          <el-table-column label="岗位名称" prop="nameTxt" width="180" ></el-table-column>
          <el-table-column label="部门简称" prop="shortNameTxt" width="180" ></el-table-column>
          <el-table-column label="岗位类型名称" prop="typeRef" width="180" ></el-table-column>
...
export default {
  ...
  methods: {
    handleAdd() {
      let context = {};
      context.title = '岗位表|新增';
      context.src = 'lite/post/litePost/litePostForm';
      context.actionType = 'add';
      context.param = {rowId: this.$refs.treeRef.getCurrentKey()};
      context.dataBind = "/lite/post/litePost/prepare";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleView(row) {
      let context = {};
      context.title = '岗位表|详情';
      context.src = 'lite/post/litePost/litePostForm';
      context.actionType = 'view';
      context.param = {
        id: row.id
      };
      context.dataBind = "/lite/post/litePost/get";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleEdit(row) {
      let context = {};
      context.title = '岗位表|编辑';
      context.src = 'lite/post/litePost/litePostForm';
    ...
    handleCopy(row) {
      let context = {};
      context.title = '岗位表|拷贝';
      context.src = 'lite/post/litePost/litePostForm';
      context.actionType = 'copy';
      context.param = {
        rowId: row.id
      }
      context.dataBind = "/lite/post/litePost/copy";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleDelete(row) {
      ...
      context.deleteAction = '/lite/post/litePost/delete';
    ...
    handleBatchDelete() {
      ...
      context.deleteAction = '/lite/post/litePost/deletes';
    ...
    handleTreeNodeClick(data) {
      this.$refs.tableRef.reload({rowId: data.id})
    },
