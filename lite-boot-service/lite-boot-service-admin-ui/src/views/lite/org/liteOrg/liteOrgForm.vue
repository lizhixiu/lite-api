	...
	<el-form :model="formData" :rules="rules" ref="formRef" label-width="100px" label-position="left">
		<el-card header="基本信息" class="box-card">
			<el-row :gutter="20">
				...
				<el-col :span="24">
					<el-form-item label="上级企业" prop="pid">
						<xc-cascader label="上级企业" id="pid" labelField="nameTxt" valueField="id"
									 :dataValue="this.formData" fieldMap="pid:id"
									 url="/lite/org/liteOrg/comTree"
									 placeholder="请选择上级企业"/>
					</el-form-item>
				</el-col>
			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="企业编码" prop="codeTxt">
						<el-input v-model="formData.codeTxt" clearable></el-input>
					</el-form-item>
				</el-col>

				<el-col :span="12 ">
					<el-form-item label="企业信用代码" prop="creditCodeTxt">
						<el-input v-model="formData.creditCodeTxt" clearable></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="企业名称" prop="nameTxt">
						<el-input v-model="formData.nameTxt" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="企业简称" prop="shortNameTxt">
			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="企业类型" prop="typeCode">
						<xc-select label="企业类型" id="typeCode" labelField="nameTxt" valueField="codeTxt"
								   :dataValue="this.formData" fieldMap="typeCode:codeTxt,typeRef:nameTxt"
								   url="/public/para/comList?classCode=SYS_ORG_TYPE"/>
					</el-form-item>
				</el-col>
				<el-col :span="12">
...
export default {
	...
	data() {
		return {
			...
			sourceData: {},
			rules: {
				pid: [{required: true, message: '请选择上级企业', trigger: 'blur'}],
				nameTxt: [{required: true, message: '请输入企业名称', trigger: 'blur'}],
				codeTxt: [{required: true, message: '请输入企业编码', trigger: 'blur'}],
				typeCode: [{required: true, message: '请选择企业类型', trigger: 'blur'}],
			}
			, context: {}
		}
	},
	...
	methods: {
		...
		handleSave() {
			let saveConfig = {};
			saveConfig.insertAction = '/lite/org/liteOrg/insert';
			saveConfig.updateAction = '/lite/org/liteOrg/update';
