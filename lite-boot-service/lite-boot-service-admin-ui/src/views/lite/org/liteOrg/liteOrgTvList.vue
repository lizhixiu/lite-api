<template>
  <el-container>
    <el-aside width="300px">
      <xcTree title="组织机构树" label="nameTxt" url="/lite/org/liteOrg/comTree"
    ...
    <el-container>
      ...
      <el-main class="nopadding">
        <xcTable title="组织机构表列表" ref="tableRef" url="/lite/org/liteOrg/page" row-key="id" stripe @selection-change="handleTableSelectionChange">
          <el-table-column type="selection" width="50"></el-table-column>
          <el-table-column type="index" label="序号" width="50"></el-table-column>
          <el-table-column label="企业编码" prop="codeTxt" width="180" sortable></el-table-column>
          <el-table-column label="企业名称" prop="nameTxt" width="180" sortable></el-table-column>
          <el-table-column label="企业简称" prop="shortNameTxt" width="180" sortable></el-table-column>
          <el-table-column label="企业统一社会信用代码" prop="creditCodeTxt" width="180" ></el-table-column>
          <el-table-column label="企业类型名称" prop="typeRef" width="180" sortable></el-table-column>
...
export default {
  ...
  methods: {
    handleAdd() {
      let context = {};
      context.title = '组织机构表|新增';
      context.src = 'lite/org/liteOrg/liteOrgForm';
      context.actionType = 'add';
      context.param = {pid: this.$refs.treeRef.getCurrentKey()};
      context.dataBind = "/lite/org/liteOrg/prepare";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleView(row) {
      let context = {};
      context.title = '组织机构表|详情';
      context.src = 'lite/org/liteOrg/liteOrgForm';
      context.actionType = 'view';
      context.param = {
        id: row.id
      };
      context.dataBind = "/lite/org/liteOrg/get";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleEdit(row) {
      let context = {};
      context.title = '组织机构表|编辑';
      context.src = 'lite/org/liteOrg/liteOrgForm';
    ...
    handleCopy(row) {
      let context = {};
      context.title = '组织机构表|拷贝';
      context.src = 'lite/org/liteOrg/liteOrgForm';
      context.actionType = 'copy';
      context.param = {
        rowId: row.id
      }
      context.dataBind = "/lite/org/liteOrg/copy";
      context.afterSuccess = this.saveAfterSuccess;
      this.$EVENTS.lay.handleOpen(this, context);
    },
    handleDelete(row) {
      ...
      context.deleteAction = '/lite/org/liteOrg/delete';
    ...
    handleBatchDelete() {
      ...
      context.deleteAction = '/lite/org/liteOrg/deletes';
