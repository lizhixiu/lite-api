<template>
	...
	<el-form :model="formData" :rules="rules" ref="formRef" label-width="100px" label-position="left">
		<el-card header="基本信息" class="box-card">
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="上级部门" prop="pid">
						<xc-cascader label="上级部门" id="pid" labelField="name" valueField="id"
				...
				<el-col :span="12">
					<el-form-item label="企业" prop="orgId">
						<xc-cascader label="企业" id="orgId" labelField="nameTxt" valueField="id"
									 :dataValue="this.formData" fieldMap="orgId:id"
									 url="/lite/org/liteOrg/comTree" disabled
									 placeholder="请选择企业"/>
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="部门编码" prop="codeTxt">
						<el-input v-model="formData.codeTxt" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="部门类型" prop="typeCode">
						<xc-select label="部门类型" id="typeCode" labelField="nameTxt" valueField="codeTxt"
								   :dataValue="this.formData" fieldMap="typeCode:codeTxt,typeRef:nameTxt"
								   url="/public/para/comList?classCode=SYS_DEPT_TYPE"/>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="部门名称" prop="nameTxt">
						<el-input v-model="formData.nameTxt" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="部门简称" prop="shortNameTxt">
...
export default {
	...
	data() {
		return {
			...
			rules: {
				...
				codeTxt: [{required: true, message: '请输入部门编码', trigger: 'blur'}],
				typeCode: [{required: true, message: '请选择部门类型', trigger: 'blur'}],
			}
			, context: {}
		}
	},
	...
	methods: {
		...
		handleSave() {
			let saveConfig = {};
			saveConfig.insertAction = '/lite/dept/liteDept/insert';
			saveConfig.updateAction = '/lite/dept/liteDept/update';
