<template>
	...
	<el-form :model="formData" :rules="rules" ref="formRef" label-width="100px" label-position="left">
		<el-card header="基本信息" class="box-card">
			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="分类编码" prop="codeTxt">
						<el-input v-model="formData.codeTxt" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="分类名称" prop="nameTxt">
				...
				<el-col :span="12">
					<el-form-item label="类型编码" prop="typeCode">
						<xc-select label="类型名称" id="typeCode" labelField="nameTxt" valueField="codeTxt"
								   ...
								   url="/public/para/comList?classCode=SYS_PARA_TYPE"/>
					</el-form-item>
				</el-col>
				<el-col :span="12">
...
export default {
	...
	data() {
		return {
			...
			rules: {
				...
				codeTxt: [
					{required: true, message: '请输入参数分类编码'}
				],
				nameTxt: [
					{required: true, message: '请输入参数分类名称'}
				],
				recSortNum: [
	...
	methods: {
		...
		handleSave() {
			let saveConfig = {};
			saveConfig.insertAction = '/lite/para/liteParaClass/insert';
			saveConfig.updateAction = '/lite/para/liteParaClass/update';
