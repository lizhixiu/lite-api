			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="分类" prop="pid">
						<xc-cascader label="上级分类" id="pid" labelField="nameTxt" valueField="id"
				...
				<el-col :span="12">
					<el-form-item label="配置类型" prop="typeCode">
						<xc-select label="类型名称" id="typeCode" labelField="nameTxt" valueField="codeTxt"
								   :dataValue="this.formData" fieldMap="typeCode:codeTxt,typeRef:nameTxt"
								   url="/public/para/comList?classCode=SYS_CONFIG_TYPE"/>
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="配置编码" prop="codeTxt">
						<el-input placeholder="请输入配置编码" v-model="formData.codeTxt" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="配置名称" prop="nameTxt">
						<el-input placeholder="请输入配置名称" v-model="formData.nameTxt" clearable></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row :gutter="20">
				<el-col :span="24">
					<el-form-item label="配置值" prop="valueTxt">
						<el-input placeholder="请输入配置值" v-model="formData.valueTxt" clearable></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="是否系统保留" prop="recSysFlag">
						<xc-switch placeholder="请输入是否系统保留" v-model="formData.recSysFlag" clearable></xc-switch>
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row :gutter="20">
				<el-col :span="12">
					<el-form-item label="排序号" prop="recSortNum">
						<el-input-number placeholder="请输入排序号" v-model="formData.recSortNum"
										 clearable></el-input-number>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="是否启用" prop="recValidFlag">
						<xc-switch placeholder="请输入是否启用" v-model="formData.recValidFlag" clearable></xc-switch>
					</el-form-item>
				</el-col>
			</el-row>
		</el-card>
...
export default {
	...
	methods: {
		...
		handleSave() {
			let saveConfig = {};
			saveConfig.insertAction = '/lite/config/liteConfig/insert';
			saveConfig.updateAction = '/lite/config/liteConfig/update';
