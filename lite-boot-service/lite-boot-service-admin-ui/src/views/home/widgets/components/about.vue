<template>
	<el-card shadow="hover" header="关于项目" class="item-background">
		...
		<p>
			<a href='https://gitee.com/xc_java/xc-union' target="_blank">
				<img src='https://gitee.com/xc_java/lite-api/badge/star.svg?theme=dark' alt='star' style="vertical-align: middle">
			</a>
		</p>
	</el-card>
</template>
