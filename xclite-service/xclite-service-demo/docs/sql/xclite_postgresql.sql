...
COMMENT ON TABLE xclite_api_info IS '数据表';

COMMENT ON COLUMN xclite_api_info.id IS '主键';
COMMENT ON COLUMN xclite_api_info.class_id IS '分类id';
COMMENT ON COLUMN xclite_api_info.table_code IS '表名';
COMMENT ON COLUMN xclite_api_info.table_name IS '表中文名';
COMMENT ON COLUMN xclite_api_info.table_desc IS '表描述';
COMMENT ON COLUMN xclite_api_info.rec_en_status IS '是否启用';
COMMENT ON COLUMN xclite_api_info.rec_del_status IS '是否删除';
COMMENT ON COLUMN xclite_api_info.rec_sys_status IS '是否系统保留';
COMMENT ON COLUMN xclite_api_info.rec_sort IS '排序号';
COMMENT ON COLUMN xclite_api_info.rec_memo IS '备注';
COMMENT ON COLUMN xclite_api_info.rec_create_uid IS '创建人ID';
COMMENT ON COLUMN xclite_api_info.rec_create_uname IS '创建人';
COMMENT ON COLUMN xclite_api_info.rec_create_datetime IS '创建时间';
COMMENT ON COLUMN xclite_api_info.rec_update_uid IS '更新人ID';
COMMENT ON COLUMN xclite_api_info.rec_update_uname IS '更新人';
COMMENT ON COLUMN xclite_api_info.rec_update_datetime IS '更新时间';
